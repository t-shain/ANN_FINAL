...
from config import ORIGINAL_DATASET_DIR
...
for cls in classes:
    ...
    print(f"Processing class '{cls}' with {len(image_paths)} images")
    ...
    save_path = f"/Users/shir/Desktop/ANN_FINAL/classification_histograms/imagenet_histogram_{cls}.png"
